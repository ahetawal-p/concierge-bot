var sendHandler = require('../util/sendMessageHandler.js');
/*
 * Authorization Event
 *
 ...
 */
 var receivedAuthentication = function(event) {
    ...
    sendHandler.sendTextMessage(senderID, "Authentication successful");
}
 ...
 */
 var receivedMessage = function(event) {
    ...
    if (messageText) {
      ...
      switch (messageText) {
        case 'image':
          sendHandler.sendImageMessage(senderID);
          break;

        case 'button':
          sendHandler.sendButtonMessage(senderID);
          break;
        ...
        case 'receipt':
          sendHandler.sendReceiptMessage(senderID);
          break;
